     	...
     	<div class="container-fluid infront">
			<div class="row justify-content-center">
				...
				<form id="options-frm" class="form" role="form" action="" onsubmit=""  method="POST">
				 				 ...
				 				 <a id="change-lang-button" onclick="document.cookie = 'lang=' + 'en' + '; path=/; expires=' + cookieOffset() + ';';  window.location.reload(true);"><img src='img/re-sync.png' width='30' height='30'></a><br/>
