		...
		<?php if($screen_type == "signup") { ?>
		 ...
		 echo $msg['msgs'][$lang]['loginSettingsButton']; 
			...
			echo $msg['msgs'][$lang]['saveSettingsButton'];
								...
								<br/>
							 <button id="sign-and-pair-button" type="submit" class="btn btn-primary" style="margin-bottom:3px;"><?php echo $notifications_config['msgs'][$lang]['signUp']; ?></button><br/><a href="<?php echo $notifications_config['msgs'][$lang]['privacyPolicyLink']; ?>"><?php echo $notifications_config['msgs'][$lang]['privacyPolicy']; ?></a><br/><br/>
