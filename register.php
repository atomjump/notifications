     	...
     	<div class="container-fluid infront">
			<div class="row justify-content-center">
				...
				<form id="options-frm" class="form" role="form" action="" onsubmit="return set_options_cookie();"  method="POST">
				 				 ...
				 				 <button id="sign-and-pair-button" type="submit" class="btn btn-primary" style="margin-bottom:3px;"><img src='img/re-sync.png' width='30' height='30'></button>
				 				 <a href="javascript:" onclick="window.location.reload(true);"><img src='img/re-sync.png' width='30' height='30'></a><br/>
